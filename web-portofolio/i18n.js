...
(function () {
    ...
    var DICT = {
        id: {
            ...
            hero_title: 'Halo, saya<br><span class="animated-name">Erlangga Satria Pratama<span class="dot">.</span></span>',
            ...
            photo_badge: 'Junior Web &amp; Mobile',
            photo_alt: 'Foto Erlangga Satria Pratama',
            ...
            learn_d: 'React dan Tailwind — masih tahap tutorial dan belum digunakan di proyek klien. Target tahun ini: satu proyek dengan React.',
            ...
            sk_sub: 'Setiap teknologi di bawah telah saya gunakan langsung di proyek nyata.',
            ...
            ok_t: 'Terima kasih, pesan Anda telah dikirim.',
            ok_d: 'Pesan sudah saya terima via Email, WhatsApp, dan Telegram. Saya akan membalas segera.',
            ...
            err_name: 'Nama minimal terdiri dari 3 huruf.', err_email: 'Alamat email tidak valid — mohon periksa kembali.',
            err_subject: 'Subjek tidak boleh kosong.', err_msg: 'Pesan minimal 10 karakter.',
            sending: 'Mengirim...',
        ...
        en: {
            ...
            hero_tag: 'Web & Flutter Mobile Developer',
            hero_title: 'Hi, I’m<br><span class="animated-name">Erlangga Satria Pratama<span class="dot">.</span></span>',
            ...
            photo_role: 'Web & Flutter Mobile Developer',
            photo_badge: 'Junior Web &amp; Mobile',
            photo_alt: 'Photo of Erlangga Satria Pratama',
            ...
            learn_d: 'React and Tailwind — still at tutorial stage and not yet used in client projects. This year’s goal: one project in React.',
            ...
            sk_sub: 'Each technology below I have used hands-on in real projects.',
            ...
            ok_t: 'Thank you, your message has been sent.',
            ok_d: 'Your message was received via Email, WhatsApp, and Telegram. I will reply soon.',
        ...
        ja: {
            ...
            ab_mastered: '習得済みの技術',
            learn_t: '学習中',
            learn_d: 'ReactとTailwind — まだ学習段階で、案件では未使用です。今年の目標はReactで1作品。',
            ...
            sk_sub: '下の技術はすべて、実案件で実際に使用したものです。',
            ...
            ok_t: 'ありがとうございます。メッセージが送信されました。',
            ok_d: 'メール、WhatsApp、Telegramでお受けしました。すぐ返信いたします。',
        ...
        ar: {
            ...
            photo_badge: 'مطور ويب وجوال مبتدئ',
            ...
            learn_d: 'React وTailwind — ما زالا في مرحلة التعلم ولم يُستخدما لعملاء بعد. هدف هذا العام: مشروع واحد بـ React.',
            ...
            sk_sub: 'كل تقنية أدناه استخدمتها عمليًا في مشاريع حقيقية.',
            ...
            ok_t: 'شكرًا لك، تم إرسال رسالتك.',
            ok_d: 'تم استلام رسالتك عبر البريد الإلكتروني وواتساب وتيليجرام. سأرد قريبًا.',
