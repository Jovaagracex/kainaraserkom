...
(function () {
    ...
    var DICT = {
        id: {
            ...
            hero_sub: 'Saya membangun website dan aplikasi mobile (Flutter) sejak 2024 — dari halaman statis hingga toko online yang terhubung ke basis data. Setiap proyek di bawah ini saya kerjakan sendiri sampai berjalan.',
        ...
        en: {
            ...
            hero_sub: 'I have been building websites and mobile apps (Flutter) since 2024 — from static pages to an online store connected to a database. Every project below I built myself until it worked.',
        ...
        ja: {
            ...
            hero_sub: '2024年からWebサイトとモバイルアプリ（Flutter）を作っています — 静的ページからデータベースとつながったネットショップまで。下の作品はすべて自分で動くまで作り上げました。',
        ...
        ar: {
            ...
            hero_sub: 'أبني المواقع وتطبيقات الجوال (Flutter) منذ 2024 — من صفحات ثابتة إلى متجر متصل بقاعدة بيانات. كل مشروع أدناه بنيته بنفسي حتى اشتغل.',
