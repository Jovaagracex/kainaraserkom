    ...
    var DICT = {
        ...
        store: {
            id: {
                ...
                ft_copy: '&copy; 2026 Kainara Studio — dikembangkan oleh Erlangga dengan HTML, CSS, JavaScript, dan Supabase.',
            ...
            en: {
                ...
                ft_copy: '&copy; 2026 Kainara Studio — developed by Erlangga with HTML, CSS, JavaScript, and Supabase.',
            ...
            ja: {
                ...
                ft_copy: '&copy; 2026 カイナラ・スタジオ — ErlanggaがHTML・CSS・JavaScript・Supabaseで開発。',
                ft_dev: '開発者ポートフォリオ',
            ...
            ar: {
                ...
                ft_copy: '&copy; 2026 كاينارا ستوديو — طوّرها Erlangga باستخدام HTML وCSS وJavaScript وSupabase.',
                ft_dev: 'أعمال المطور',
        ...
        admin: {
            id: {
                ...
                soon: 'Laporan omzet mingguan lagi digarap — sabar ya, Bos.',
            ...
            en: {
                ...
                soon: 'Weekly revenue report is still being built — hang tight, Boss.',
            ...
            ar: {
                ...
                soon: 'تقرير الإيرادات الأسبوعي قيد الإنشاء — اصبر علينا يا بوس.',
