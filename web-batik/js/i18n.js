    ...
    var DICT = {
        ...
        store: {
            id: {
                ...
                off_msg: 'Anda sedang offline — katalog mungkin tidak terbaru. Mohon periksa koneksi.',
                ...
                cat_tulis: 'Batik Tulis', cat_cap: 'Batik Cap', cat_print: 'Batik Printing', cat_kemeja: 'Kemeja', cat_gaun: 'Gaun', cat_kain: 'Kain', cat_other: 'Lainnya',
                ...
                fav: 'Favorit', fav_aria: 'Hanya favorit',
                ...
                steps_eyebrow: 'Mudah diikuti', steps_title: 'Cara Pesan',
                ...
                steps_note: 'Masih ragu? Silakan bertanya terlebih dahulu — tanpa kewajiban membeli.',
                ...
                p1: 'Saya tidak memiliki toko fisik. Seluruh proses saya kerjakan sendiri: foto produk, unggah katalog, kemas paket, hingga membalas pesan. Apabila balasan agak terlambat, kemungkinan saya sedang ke kantor pos.',
                r1t: 'Motif saya pilih sendiri.', r1d: 'Nggak semua kain dari pengrajin saya ambil — cuma yang bahannya adem dan jahitannya rapi.',
                r2t: 'Harga wajar, bukan harga turis.', r2d: 'Karena tanpa perantara, selisih biayanya saya kembalikan ke harga.',
                r3t: 'Salah kirim? Tukar.', r3d: 'Cukup kirimkan foto barangnya, saya akan mengirim pengganti. Sejauh ini baru 2 kali terjadi.',
                xp: 'Tahun<br>Berkarya',
                about_img_alt: 'Proses membatik', about_mini_alt: 'Detail motif batik',
                testi_eyebrow: 'Testimoni', testi_title: 'Kata Mereka',
                testi_sub: 'Saya kutip apa adanya dari chat pembeli — termasuk typo-nya.',
                t1: '"Batiknya adem bgt, jahitannya juga rapi 👍 Udah 3x beli disini gapernah kecewa. Makasih min!"',
                t2: '"Buat seragam kantor kemarin, motifnya beda dari yg lain. Packing rapi, sampe 2 hari. Mantap."',
                t3: '"Gaunnya cantik, cocok buat kondangan 🥰 minus dikit pengiriman agak lama karna ekspedisi, tapi adminnya fast respon kok"',
                t1n: 'Siti R.', t1c: 'Jakarta Selatan', t2n: 'Budi H.', t2c: 'Sidoarjo', t3n: 'Anisa P.', t3c: 'Bandung',
                ...
                ft_nav: 'Navigasi', ft_cat: 'Koleksi', ft_info: 'Informasi', ft_service: 'Layanan', ft_studio: 'Studio',
                ...
                ft_all: 'Semua Koleksi', ft_wa: 'Order via WhatsApp',
                ft_copy: '&copy; 2026 Kainara Studio.',
                ft_dev: 'Portofolio Developer',
                ft_secure: 'Transaksi Aman',
                ft_trust1: '100% Batik Asli', ft_trust2: 'Kurasi Pengrajin Lokal', ft_trust3: 'Kirim Maks 2x24 Jam',
                ft_trust4: 'Garansi Retur 100%', ft_trust5: 'Layanan WhatsApp 24/7',
                ...
                ts_revfill: 'Mohon isi nama dan ulasan terlebih dahulu.', ts_revthanks: 'Terima kasih atas ulasannya!',
            ...
            en: {
                ...
                cat_tulis: 'Hand-drawn Batik', cat_cap: 'Stamped Batik', cat_print: 'Printed Batik', cat_kemeja: 'Shirts', cat_gaun: 'Gowns', cat_kain: 'Fabric', cat_other: 'Others',
                ...
                fav: 'Favorites', fav_aria: 'Favorites only',
                ...
                r2t: 'Fair prices, not tourist prices.', r2d: 'With no middlemen, the savings are passed on to you in the price.',
                r3t: 'Wrong item? Exchange it.', r3d: 'Simply send a photo of the item and I’ll send a replacement. It has only happened twice so far.',
                xp: 'Years<br>of Craft',
                about_img_alt: 'Batik-making process', about_mini_alt: 'Batik motif detail',
                testi_eyebrow: 'Reviews', testi_title: 'Their Words',
                testi_sub: 'Quoted as-is from buyers\u2019 chats — typos included.',
                t1: '"Fabric is so comfy n the stitching\u2019s neat too 👍 Bought 3x already, never disappointed. Thx min!"',
                t2: '"Got office uniforms here, the motif stands out from the rest. Neat packing, arrived in 2 days. Solid."',
                t3: '"The gown is lovely, perfect for weddings 🥰 only minus shipping took a while coz of the courier, but admin replies fast tho"',
                t1n: 'Siti R.', t1c: 'South Jakarta', t2n: 'Budi H.', t2c: 'Sidoarjo', t3n: 'Anisa P.', t3c: 'Bandung',
                ...
                ft_nav: 'Navigate', ft_cat: 'Collections', ft_info: 'Information', ft_service: 'Services', ft_studio: 'Studio',
                ...
                ft_all: 'All Collections', ft_wa: 'Order via WhatsApp',
                ft_copy: '&copy; 2026 Kainara Studio.',
                ft_dev: 'Developer Portfolio',
                ft_secure: 'Secure Transactions',
                ft_trust1: '100% Authentic Batik', ft_trust2: 'Curated Local Artisans', ft_trust3: 'Ships within 2x24 Hours',
                ft_trust4: '100% Return Guarantee', ft_trust5: 'WhatsApp Support 24/7',
            ...
            ja: {
                ...
                cat_tulis: '手描きバティック', cat_cap: '型押しバティック', cat_print: 'プリントバティック', cat_kemeja: 'シャツ', cat_gaun: 'ドレス', cat_kain: '生地', cat_other: 'その他',
                sort_lo: '価格：安い順', sort_hi: '価格：高い順', sort_az: '名前：A-Z', sort_za: '名前：Z-A',
                min_ph: '最低 Rp', max_ph: '最高 Rp', min_aria: '最低価格', max_aria: '最高価格',
                fav: 'お気に入り', fav_aria: 'お気に入りのみ',
                ...
                r2t: '適正価格、観光客価格ではありません。', r2d: '中間業者がいない分、その差額は価格に還元しています。',
                r3t: '誤送？交換します。', r3d: '商品の写真を送っていただければ、代替品を送ります。これまで2回だけ起きました。',
                xp: '年の<br>職歴',
                about_img_alt: 'バティック制作の工程', about_mini_alt: 'バティック柄の細部',
                testi_eyebrow: 'レビュー', testi_title: 'お客様の声',
                testi_sub: '購入者チャットの原文ママ — 誤字もそのまま。',
                t1: '"生地が涼しくて縫製もキレイ👍 もう3回買ってるけどハズレなし！ありがとー！"',
                t2: '"会社の制服に。柄が他と違って目立つ。梱包も丁寧で2日で届いた。最高。"',
                t3: '"ドレス可愛くて結婚式にぴったり🥰 配送がちょっと遅かったのが残念だけど、返信は早かったからOK"',
                t1n: 'Siti R.', t1c: '南ジャカルタ', t2n: 'Budi H.', t2c: 'シドアルジョ', t3n: 'Anisa P.', t3c: 'バンドン',
                ...
                ft_nav: 'メニュー', ft_cat: 'カテゴリ', ft_info: '案内', ft_service: 'サービス', ft_studio: 'スタジオ',
                ft_about: '私たちについて', ft_contact: '連絡先', ft_admin: '管理パネル',
                ft_special: '特別コレクション', ft_how: '注文方法', ft_help: '連絡＆ヘルプ', ft_top: 'トップに戻る',
                ft_all: '全コレクション', ft_wa: 'WhatsAppで注文',
                ft_copy: '&copy; 2026 カイナラ・スタジオ',
                ft_dev: '開発者ポートフォリオ',
                ft_secure: '安全な取引',
                ft_trust1: '100%本物バティック', ft_trust2: '地元職人の厳選', ft_trust3: '48時間以内に発送',
                ft_trust4: '100%返品保証', ft_trust5: 'WhatsApp対応24/7',
            ...
            ar: {
                ...
                cat_tulis: 'باتيك يدوي', cat_cap: 'باتيك مختوم', cat_print: 'باتيك مطبوع', cat_kemeja: 'قمصان', cat_gaun: 'فساتين', cat_kain: 'أقمشة', cat_other: 'أخرى',
                ...
                fav: 'المفضلة', fav_aria: 'المفضلة فقط',
                ...
                r2t: 'أسعار عادلة وليست أسعار سياح.', r2d: 'بدون وسطاء، يُعاد الفرق إلى السعر.',
                ...
                testi_eyebrow: 'آراء', testi_title: 'كلامهم',
                testi_sub: 'منقول حرفيًا من محادثات المشترين — بالأخطاء الإملائية.',
                t1: '"القماش مريح والخياطة مرتبة مرة 👍 اشتريت ٣ مرات وما خاب ظني ابد. شكرًا!"',
                t2: '"أخذت زي للدوام، النقشة غير عن الكل. التغليف مرتب ووصل بيومين. ممتاز."',
                t3: '"الفستان يجنن، مناسب للحفلات 🥰 بس الشحن تأخر شوي بسبب الشركة، لكن الرد كان سريع"',
                t1n: 'Siti R.', t1c: 'جنوب جاكرتا', t2n: 'Budi H.', t2c: 'سيدوارجو', t3n: 'Anisa P.', t3c: 'باندونغ',
                ...
                ft_nav: 'تصفح', ft_cat: 'الفئات', ft_info: 'معلومات', ft_service: 'خدمات', ft_studio: 'الاستوديو',
                ...
                ft_all: 'كل المجموعات', ft_wa: 'اطلب عبر واتساب',
                ft_copy: '&copy; 2026 كاينارا ستوديو.',
                ft_dev: 'أعمال المطور',
                ft_secure: 'معاملات آمنة',
                ft_trust1: 'باتيك أصلي 100%', ft_trust2: 'حرفيون محليون مختارون', ft_trust3: 'شحن خلال 48 ساعة',
                ft_trust4: 'ضمان إرجاع 100%', ft_trust5: 'دعم واتساب 24/7',
        ...
        admin: {
            id: {
                ...
                greet: 'Selamat datang kembali.', greet_s: 'Berikut kondisi toko hari ini — ',
                ...
                soon: 'Laporan omzet mingguan sedang disusun — segera hadir.',
            ...
            en: {
                ...
                greet: 'Welcome back.', greet_s: 'Here is your store today — ',
                ...
                soon: 'The weekly revenue report is being prepared — coming soon.',
            ...
            ja: {
                ...
                greet: 'おかえりなさい。', greet_s: '今日のお店の様子 — ',
            ...
            ar: {
                ...
                greet: 'مرحبًا بعودتك.', greet_s: 'هذه حالة متجرك اليوم — ',
                ...
                soon: 'تقرير الإيرادات الأسبوعي قيد الإعداد — قريبًا.',
